  ...
  return (
    <main style={{ minHeight: '100vh', background: 'var(--color-background-secondary)', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto', padding: '24px 16px', position: 'relative' }}>
        <div style={{ position: 'absolute', top: '40px', right: '-40px', width: '80px', height: '80px', borderRadius: '50%', background: '#E1F5EE', opacity: 0.5, pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', top: '120px', left: '-40px', width: '50px', height: '50px', borderRadius: '50%', background: '#9FE1CB', opacity: 0.2, pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', top: '250px', right: '-20px', width: '35px', height: '35px', borderRadius: '50%', background: '#5DCAA5', opacity: 0.15, pointerEvents: 'none' }} />
